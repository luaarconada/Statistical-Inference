...
x= c(6.2,7.3,5.5,6.7,9,7.1,5,6.3,7.2,7.5,8,7.9,6.5,6.1,7)
theta_hat =function(x) {mean(x)}
boot_ci(x = x, theta_hat = function(x) mean(x), B = 1e4, alpha = 0.01)
boot_ci(x=x,theta_hat=function(x) var(x), B=1e4, alpha=0.01)


y = c(2072, 2726, 2254, 3029,  2283 , 2673, 2401, 2463, 2416,2909,2385, 2055,
      2139, 2553, 2453, 2621, 2808, 3583, 2662, 2732, 1996, 2164,  2036,2915,
      2507, 3245,  2337 ,2672,3089, 3012, 2725, 2467, 2439, 2692,1793,3845,
      2523, 2585, 1647, 2072,   1988, 2767, 3679,  2280   ,  2642 , 3112,
      2512, 2435, 2820, 2142, 3197, 3103, 2130,  3213 , 2464, 2243, 2958,
      2529, 2160,2484)
boot_ci(x=y, theta_hat=function(x) mean(x), B=1e4, alpha=0.01)
